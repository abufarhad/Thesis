...
class Net(nn.Module):
    def __init__(self, params):
        ...
        '''Dropout technique is essentially a regularization method 
        used to prevent over-fitting while training neural nets. '''
...
def accuracy(outputs, labels):
    ...
    # returns the index of maximum of in every column(axis=0), and row(axis=1).
